...
public:
	...
	{
		EChatClient(const NLMISC::CEntityId &id)
		    : Exception("Don't have chat infos for the char " + id.toString())
		{
		}
	};
	...
	{
		EChatGroup(const TGroupId &gId)
		    : Exception("Can't find the group " + gId.toString())
		{
		}
	};
