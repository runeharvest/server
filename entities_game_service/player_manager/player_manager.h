...
public:
	...
	{
		EPlayer(uint32 userId)
		    : Exception("Player " + NLMISC::toString(userId) + " not found")
		{
		}
	};
	...
	{
		EChar(const NLMISC::CEntityId &id)
		    : Exception("The char " + id.toString() + " doesn't exist")
		{
		}
	};
...
#define RY_SEND_IMPULSE_TO_CLIENT_END                                 \
	...
	template <class P1>
	void sendImpulseToClient(const NLMISC::CEntityId &id, const std::string &msgName, const P1 &p1)
	{
		RY_SEND_IMPULSE_TO_CLIENT_BEGIN
	...
	void sendImpulseToClient(const NLMISC::CEntityId &id, const std::string &msgName, const P1 &p1, const P2 &p2)
	{
		RY_SEND_IMPULSE_TO_CLIENT_BEGIN
		bms.serial(const_cast<P1 &>(p1));
	...
	void sendImpulseToClient(const NLMISC::CEntityId &id, const std::string &msgName, const P1 &p1, const P2 &p2, const P3 &p3)
	{
		RY_SEND_IMPULSE_TO_CLIENT_BEGIN
		bms.serial(const_cast<P1 &>(p1));
		bms.serial(const_cast<P2 &>(p2));
	...
	void sendImpulseToClient(const NLMISC::CEntityId &id, const std::string &msgName, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4)
	{
		RY_SEND_IMPULSE_TO_CLIENT_BEGIN
		bms.serial(const_cast<P1 &>(p1));
		bms.serial(const_cast<P2 &>(p2));
	...
	void sendImpulseToClient(const NLMISC::CEntityId &id, const std::string &msgName, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5)
	{
		RY_SEND_IMPULSE_TO_CLIENT_BEGIN
		bms.serial(const_cast<P1 &>(p1));
		bms.serial(const_cast<P2 &>(p2));
	...
	void sendImpulseToClient(const NLMISC::CEntityId &id, const std::string &msgName, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6)
	{
		RY_SEND_IMPULSE_TO_CLIENT_BEGIN
		bms.serial(const_cast<P1 &>(p1));
		bms.serial(const_cast<P2 &>(p2));
