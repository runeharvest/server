...
private:
	...
	struct CTeamDamageScore
	{
		...
		CTeamDamageScore(TTeamId teamId, double totalDamage, uint32 maxSkillValue)
		    : TeamId(teamId)
	...
	struct CPlayerDamageScore
	{
		...
		CPlayerDamageScore(TDataSetRow playerRowId, double totalDamage, uint32 maxSKillValue)
	...
	{
		CCreatureDamageScore()
		    : TotalDamage(0.0)
		{
		}
		CCreatureDamageScore(TDataSetRow creatureRowId, double totalDamage)
		    : CreatureRowId(creatureRowId)
		    , TotalDamage(totalDamage)
		{
		}
