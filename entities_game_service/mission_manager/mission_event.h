...
public:
	CMissionEventMissionDone(uint32 alias)
	    : CMissionEvent(MissionDone, TDataSetRow())
	    , Mission(alias)
	{
	}
	uint32 Mission;
...
public:
	CMissionEventGiveMoney(uint32 amount)
	    : CMissionEvent(GiveMoney, TDataSetRow())
	    , Amount(amount)
	{
	}
	uint32 Amount;
...
public:
	CMissionEventVisitPlace(uint32 placeId)
	    : CMissionEvent(EnterZone, TDataSetRow())
	    , PlaceId(placeId)
	{
	}
	uint32 PlaceId;
...
public:
	CMissionEventCast(const std::vector<NLMISC::CSheetId> &bricks)
	    : CMissionEvent(Cast, TDataSetRow())
	    , Bricks(bricks)
	{
	}
...
public:
	CMissionEventForage(const NLMISC::CSheetId &item, uint32 quantity, uint16 quality)
	    : CMissionEvent(Forage, TDataSetRow())
	    , Sheet(item)
	    , Quantity(quantity)
	    , Quality(quality)
	{
...
public:
	CMissionEventSkillProgress(SKILLS::ESkills skill, uint level)
	    : CMissionEvent(SkillProgress, TDataSetRow())
	    , Skill(skill)
	    , Level(level)
	{
	}
...
public:
	CMissionEventCraft(const NLMISC::CSheetId &item, uint32 quantity, uint16 quality)
	    : CMissionEvent(Craft, TDataSetRow())
	    , Sheet(item)
	    , Quantity(quantity)
	    , Quality(quality)
	{
...
public:
	CMissionEventEscort(TAIAlias mission)
	    : CMissionEvent(Escort, TDataSetRow())
	    , Mission(mission)
	{
	}
	TAIAlias Mission;
...
public:
	CMissionEventAIMsg(const std::string &msg)
	    : CMissionEvent(AIMsg, TDataSetRow())
	    , Msg(msg)
	{
	}
	std::string Msg;
...
public:
	CMissionEventLootItem(const NLMISC::CSheetId &item, uint32 quantity, uint16 quality)
	    : CMissionEvent(LootItem, TDataSetRow())
	    , Sheet(item)
	    , Quantity(quantity)
	    , Quality(quality)
	{
...
public:
	CMissionEventLootRm(const NLMISC::CSheetId &item, uint32 quantity, uint16 quality)
	    : CMissionEvent(LootRm, TDataSetRow())
	    , Sheet(item)
	    , Quantity(quantity)
	    , Quality(quality)
	{
...
public:
	CMissionEventKillGroup(TAIAlias alias, CMissionEvent::TRestriction restriction)
	    : CMissionEvent(KillGroup, TDataSetRow(), restriction)
	    , Alias(alias)
	{
	}
...
public:
	CMissionEventChargePoints(uint32 points)
	    : CMissionEvent(ChargePoints, TDataSetRow())
	    , Points(points)
	{
	}
	uint32 Points;
...
public:
	CMissionEventAddMission(TAIAlias giver, TAIAlias mission, TAIAlias mainMission, bool guild)
	    : CMissionEvent(AddMission, TDataSetRow())
	    , Giver(giver)
	    , Mission(mission)
...
public:
	CMissionEventGroupSpawned(TAIAlias alias)
	    : CMissionEvent(GroupSpawned, TDataSetRow())
	    , Alias(alias)
	{
	}
...
public:
	CMissionEventGroupDespawned(TAIAlias alias)
	    : CMissionEvent(GroupDespawned, TDataSetRow())
	    , Alias(alias)
	{
	}
