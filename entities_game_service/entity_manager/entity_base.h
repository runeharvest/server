...
public:
	...
	*/
	...
	inline void decPreventEntityMove()
	{
		if (_PreventEntityMoves > 0) --_PreventEntityMoves;
	}
	...
	inline void incDamageShield(uint16 value)
	{
		_DamageShieldDamage += value;
		_DamageShieldHpDrain += value;
	}
	inline void decDamageShield(uint16 value)
	{
		_DamageShieldDamage -= value;
		_DamageShieldHpDrain -= value;
	}
