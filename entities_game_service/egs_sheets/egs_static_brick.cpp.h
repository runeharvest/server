...
public:
	...
	const TBrickParam &operator=(std::string copyOfStr)
	{
		...
		if (copyOfStr == "sta_weight_factor")
		{
			_Value = STA_WEIGHT_FACTOR;
			return *this;
		}
		if (copyOfStr == "focus")
		{
		...
		if (copyOfStr == "set_behaviour")
		{
			_Value = SET_BEHAVIOUR;
			return *this;
		}
		if (copyOfStr == "define_flag")
		{
			_Value = DEFINE_FLAG;
			return *this;
		}
		if (copyOfStr == "bypass_check")
		{
			_Value = BYPASS_CHECK;
			return *this;
		}
		if (copyOfStr == "latency_factor")
		{
			_Value = LATENCY_FACTOR;
			return *this;
		}
		if (copyOfStr == "sta_loss_factor")
		{
			_Value = STA_LOSS_FACTOR;
			return *this;
		}
		if (copyOfStr == "debuff_regen")
		{
			_Value = DEBUFF_REGEN;
			return *this;
		}
		if (copyOfStr == "sap_loss_factor")
		{
			_Value = SAP_LOSS_FACTOR;
			return *this;
		}
		if (copyOfStr == "aim")
		{
		...
		if (copyOfStr == "att_skill_mod")
		{
			_Value = ATT_SKILL_MOD;
			return *this;
		}
		if (copyOfStr == "defense_mod")
		{
			_Value = DEFENSE_MOD;
			return *this;
		}
		if (copyOfStr == "throw_off_balance")
		{
			_Value = THROW_OFF_BALANCE;
			return *this;
		}
		if (copyOfStr == "inc_dmg")
		{
			_Value = INC_DMG;
			return *this;
		}
		if (copyOfStr == "inc_dmg_type_rstr")
		{
			_Value = INC_DMG_TYPE_RSTR;
			return *this;
		}
		if (copyOfStr == "inc_dmg_race_rstr")
		{
			_Value = INC_DMG_RACE_RSTR;
			return *this;
		}
		if (copyOfStr == "inc_dmg_ecos_rstr")
		{
			_Value = INC_DMG_ECOS_RSTR;
			return *this;
		}
		if (copyOfStr == "inc_dmg_season_rstr")
		{
			_Value = INC_DMG_SEASON_RSTR;
			return *this;
		}
		if (copyOfStr == "special_damage")
		{
			_Value = SPECIAL_DAMAGE;
			return *this;
		}
		if (copyOfStr == "armor_mod")
		{
			_Value = ARMOR_MOD;
			return *this;
		}
		if (copyOfStr == "slow_cast")
		{
			_Value = SLOW_CAST;
			return *this;
		}
		if (copyOfStr == "opening_1")
		{
			_Value = OPENING_1;
			return *this;
		}
		if (copyOfStr == "opening_2")
		{
			_Value = OPENING_2;
			return *this;
		}
		if (copyOfStr == "opening_3")
		{
			_Value = OPENING_3;
			return *this;
		}
		if (copyOfStr == "combat_slow_attack")
		{
			_Value = COMBAT_SLOW_ATTACK;
			return *this;
		}
		if (copyOfStr == "combat_slow")
		{
			_Value = COMBAT_SLOW;
			return *this;
		}
		if (copyOfStr == "bleed_factor")
		{
			_Value = BLEED_FACTOR;
			return *this;
		}
		if (copyOfStr == "special_hit")
		{
			_Value = SPECIAL_HIT;
			return *this;
		}
		if (copyOfStr == "hit_all_aggressors")
		{
			_Value = HIT_ALL_AGGRESSORS;
			return *this;
		}
		if (copyOfStr == "weapon_wear_mod")
		{
			_Value = WEAPON_WEAR_MOD;
			return *this;
		}
		if (copyOfStr == "critical_hit_mod")
		{
			_Value = CRITICAL_HIT_MOD;
			return *this;
		}
		if (copyOfStr == "ma")
		{
		...
		if (copyOfStr == "ma_effect")
		{
			_Value = MA_EFFECT;
			return *this;
		}
		if (copyOfStr == "ma_stat")
		{
			_Value = MA_STAT;
			return *this;
		}
		if (copyOfStr == "ma_effect_mod")
		{
			_Value = MA_EFFECT_MOD;
			return *this;
		}
		if (copyOfStr == "ma_effect_mult")
		{
			_Value = MA_EFFECT_MULT;
			return *this;
		}
		if (copyOfStr == "ma_casting_time")
		{
			_Value = MA_CASTING_TIME;
			return *this;
		}
		if (copyOfStr == "ma_dmg_type")
		{
			_Value = MA_DMG_TYPE;
			return *this;
		}
		...
		if (copyOfStr == "ma_heal")
		{
			_Value = MA_HEAL;
			return *this;
		}
		if (copyOfStr == "ma_range")
		{
			_Value = MA_RANGE;
			return *this;
		}
		if (copyOfStr == "ma_link_cost")
		{
			_Value = MA_LINK_COST;
			return *this;
		}
		if (copyOfStr == "ma_link_period")
		{
			_Value = MA_LINK_PERIOD;
			return *this;
		}
		if (copyOfStr == "ma_cure")
		{
			_Value = MA_CURE;
			return *this;
		}
		if (copyOfStr == "ma_link_power")
		{
			_Value = MA_LINK_POWER;
			return *this;
		}
		if (copyOfStr == "ma_break_res")
		{
			_Value = MA_BREAK_RES;
			return *this;
		}
		if (copyOfStr == "ma_armor_comp")
		{
			_Value = MA_ARMOR_COMP;
			return *this;
		}
		if (copyOfStr == "ma_vampirise")
		{
			_Value = MA_VAMPIRISE;
			return *this;
		}
		if (copyOfStr == "ma_vampirise_ratio")
		{
			_Value = MA_VAMPIRISE_RATIO;
			return *this;
		}
		if (copyOfStr == "cr_recommended")
		{
			_Value = CR_RECOMMENDED;
			return *this;
		}
		if (copyOfStr == "cr_hp")
		{
		...
		if (copyOfStr == "cr_focus")
		{
			_Value = CR_FOCUS;
			return *this;
		}
		if (copyOfStr == "cr_quality")
		{
			_Value = CR_QUALITY;
			return *this;
		}
		if (copyOfStr == "cr_durability")
		{
			_Value = CR_DURABILITY;
			return *this;
		}
		if (copyOfStr == "cr_damage")
		{
			_Value = CR_DAMAGE;
			return *this;
		}
		if (copyOfStr == "cr_hitrate")
		{
			_Value = CR_HITRATE;
			return *this;
		}
		if (copyOfStr == "cr_range")
		{
			_Value = CR_RANGE;
			return *this;
		}
		if (copyOfStr == "cr_dmg_protection")
		{
			_Value = CR_DMG_PROTECTION;
			return *this;
		}
		if (copyOfStr == "cr_sapload")
		{
			_Value = CR_SAPLOAD;
			return *this;
		}
		if (copyOfStr == "cr_weight")
		{
			_Value = CR_WEIGHT;
			return *this;
		}
		if (copyOfStr == "fg_range")
		{
			_Value = FG_RANGE;
			return *this;
		}
		if (copyOfStr == "fg_ld_range")
		{
			_Value = FG_LD_RANGE;
			return *this;
		}
		if (copyOfStr == "fg_angle")
		{
			_Value = FG_ANGLE;
			return *this;
		}
		if (copyOfStr == "fg_multi")
		{
			_Value = FG_MULTI;
			return *this;
		}
		if (copyOfStr == "fg_know")
		{
			_Value = FG_KNOW;
			return *this;
		}
		if (copyOfStr == "fg_time")
		{
			_Value = FG_TIME;
			return *this;
		}
		if (copyOfStr == "fg_src_time")
		{
			_Value = FG_SRC_TIME;
			return *this;
		}
		if (copyOfStr == "fg_stat_energy")
		{
			_Value = FG_STAT_ENERGY;
			return *this;
		}
		if (copyOfStr == "fg_stat_energy_only")
		{
			_Value = FG_STAT_ENERGY_ONLY;
			return *this;
		}
		if (copyOfStr == "fg_vis_dist")
		{
			_Value = FG_VIS_DIST;
			return *this;
		}
		if (copyOfStr == "fg_vis_stealth")
		{
			_Value = FG_VIS_STEALTH;
			return *this;
		}
		if (copyOfStr == "fg_src_locator")
		{
			_Value = FG_SRC_LOCATOR;
			return *this;
		}
		if (copyOfStr == "fg_attempts")
		{
			_Value = FG_ATTEMPTS;
			return *this;
		}
		if (copyOfStr == "fg_abs_s")
		{
			_Value = FG_ABS_S;
			return *this;
		}
		if (copyOfStr == "fg_abs_a")
		{
			_Value = FG_ABS_A;
			return *this;
		}
		if (copyOfStr == "fg_abs_q")
		{
			_Value = FG_ABS_Q;
			return *this;
		}
		if (copyOfStr == "fg_src_prd")
		{
			_Value = FG_SRC_PRD;
			return *this;
		}
		if (copyOfStr == "fg_src_apt")
		{
			_Value = FG_SRC_APT;
			return *this;
		}
		if (copyOfStr == "fg_quality")
		{
			_Value = FG_QUALITY;
			return *this;
		}
		if (copyOfStr == "fg_pres")
		{
			_Value = FG_PRES;
			return *this;
		}
		if (copyOfStr == "fg_stab")
		{
			_Value = FG_STAB;
			return *this;
		}
		if (copyOfStr == "fg_cr_stealth")
		{
			_Value = FG_CR_STEALTH;
			return *this;
		}
		if (copyOfStr == "fg_abs_src_dmg")
		{
			_Value = FG_ABS_SRC_DMG;
			return *this;
		}
		if (copyOfStr == "kami_offering")
		{
			_Value = KAMI_OFFERING;
			return *this;
		}
		if (copyOfStr == "kami_anger_decrease")
		{
			_Value = KAMI_ANGER_DECREASE;
			return *this;
		}
		if (copyOfStr == "fg_reduce_dmg")
		{
			_Value = FG_REDUCE_DMG;
			return *this;
		}
		if (copyOfStr == "fg_ect_spc")
		{
			_Value = FG_ECT_SPC;
			return *this;
		}
		if (copyOfStr == "fg_rmgrp_filt")
		{
			_Value = FG_RMGRP_FILT;
			return *this;
		}
		if (copyOfStr == "fg_rmfam_filt")
		{
			_Value = FG_RMFAM_FILT;
			return *this;
		}
		if (copyOfStr == "fg_itempart_filt")
		{
			_Value = FG_ITEMPART_FILT;
			return *this;
		}
		if (copyOfStr == "sp_taunt")
		{
			_Value = SP_TAUNT;
			return *this;
		}
		if (copyOfStr == "sp_shielding")
		{
			_Value = SP_SHIELDING;
			return *this;
		}
		if (copyOfStr == "sp_life_aura")
		{
			_Value = SP_LIFE_AURA;
			return *this;
		}
		if (copyOfStr == "sp_life_aura2")
		{
			_Value = SP_LIFE_AURA2;
			return *this;
		}
		if (copyOfStr == "sp_stamina_aura")
		{
			_Value = SP_STAMINA_AURA;
			return *this;
		}
		if (copyOfStr == "sp_stamina_aura2")
		{
			_Value = SP_STAMINA_AURA2;
			return *this;
		}
		if (copyOfStr == "sp_sap_aura")
		{
			_Value = SP_SAP_AURA;
			return *this;
		}
		if (copyOfStr == "sp_sap_aura2")
		{
			_Value = SP_SAP_AURA2;
			return *this;
		}
		if (copyOfStr == "sp_speeding_up")
		{
			_Value = SP_SPEEDING_UP;
			return *this;
		}
		if (copyOfStr == "sp_invulnerability")
		{
			_Value = SP_INVULNERABILITY;
			return *this;
		}
		if (copyOfStr == "sp_melee_protection_aura")
		{
			_Value = SP_MELEE_PROTECTION_AURA;
			return *this;
		}
		if (copyOfStr == "sp_range_protection_aura")
		{
			_Value = SP_RANGE_PROTECTION_AURA;
			return *this;
		}
		if (copyOfStr == "sp_magic_protection_aura")
		{
			_Value = SP_MAGIC_PROTECTION_AURA;
			return *this;
		}
		if (copyOfStr == "sp_war_cry_aura")
		{
			_Value = SP_WAR_CRY_AURA;
			return *this;
		}
		if (copyOfStr == "sp_fire_wall_aura")
		{
			_Value = SP_FIRE_WALL_AURA;
			return *this;
		}
		if (copyOfStr == "sp_thorn_wall_aura")
		{
			_Value = SP_THORN_WALL_AURA;
			return *this;
		}
		if (copyOfStr == "sp_water_wall_aura")
		{
			_Value = SP_WATER_WALL_AURA;
			return *this;
		}
		if (copyOfStr == "sp_lightning_wall_aura")
		{
			_Value = SP_LIGHTNING_WALL_AURA;
			return *this;
		}
		if (copyOfStr == "sp_berserk")
		{
			_Value = SP_BERSERK;
			return *this;
		}
		if (copyOfStr == "sp_enchant_weapon")
		{
			_Value = SP_ENCHANT_WEAPON;
			return *this;
		}
		if (copyOfStr == "sp_calm_animal")
		{
			_Value = SP_CALM_ANIMAL;
			return *this;
		}
		if (copyOfStr == "needed_brick_flag")
		{
			_Value = NEEDED_BRICK_FLAG;
			return *this;
		}
		if (copyOfStr == "sp_balance")
		{
			_Value = SP_BALANCE;
			return *this;
		}
		if (copyOfStr == "sp_heal")
		{
			_Value = SP_HEAL;
			return *this;
		}
		if (copyOfStr == "sp_recast_time")
		{
			_Value = SP_RECAST_TIME;
			return *this;
		}
		if (copyOfStr == "sp_chg_charac")
		{
			_Value = SP_CHG_CHARAC;
			return *this;
		}
		if (copyOfStr == "sp_mod_defense")
		{
			_Value = SP_MOD_DEFENSE;
			return *this;
		}
		if (copyOfStr == "sp_mod_craft_success")
		{
			_Value = SP_MOD_CRAFT_SUCCESS;
			return *this;
		}
		if (copyOfStr == "sp_mod_melee_success")
		{
			_Value = SP_MOD_MELEE_SUCCESS;
			return *this;
		}
		if (copyOfStr == "sp_mod_range_success")
		{
			_Value = SP_MOD_RANGE_SUCCESS;
			return *this;
		}
		if (copyOfStr == "sp_mod_magic_success")
		{
			_Value = SP_MOD_MAGIC_SUCCESS;
			return *this;
		}
		if (copyOfStr == "sp_mod_forage_success")
		{
			_Value = SP_MOD_FORAGE_SUCCESS;
			return *this;
		}
		if (copyOfStr == "sp_mod_magic_protection")
		{
			_Value = SP_MOD_MAGIC_PROTECTION;
			return *this;
		}
		if (copyOfStr == "bonus_fg_extraction_time_gc")
		{
			_Value = BONUS_FG_EXTRACTION_TIME_GC;
			return *this;
		}
		if (copyOfStr == "bonus_cr_durability")
		{
			_Value = BONUS_CR_DURABILITY;
			return *this;
		}
		if (copyOfStr == "bonus_landmark_number")
		{
			_Value = BONUS_LANDMARK_NUMBER;
			return *this;
		}
		if (copyOfStr == "area_bomb")
		{
			_Value = AREA_BOMB;
			return *this;
		}
		if (copyOfStr == "area_spray")
		{
			_Value = AREA_SPRAY;
			return *this;
		}
		if (copyOfStr == "area_chain")
		{
			_Value = AREA_CHAIN;
			return *this;
		}
		if (copyOfStr == "area_targets")
		{
			_Value = AREA_TARGETS;
			return *this;
		}
		if (copyOfStr == "ma_recharge")
		{
			_Value = MA_RECHARGE;
			return *this;
		}
		if (copyOfStr == "charac_upgrade")
		{
			_Value = CHARAC_UPGRADE;
			return *this;
		}
		if (copyOfStr == "score_upgrade")
		{
			_Value = SCORE_UPGRADE;
			return *this;
		}
		if (copyOfStr == "ta_teleport")
		{
			_Value = TA_TELEPORT;
			return *this;
		}
		if (copyOfStr == "ta_disconnect")
		{
			_Value = TA_DISCONNECT;
			return *this;
		}
		if (copyOfStr == "ta_mount")
		{
			_Value = TA_MOUNT;
			return *this;
		}
		if (copyOfStr == "ta_unmount")
		{
			_Value = TA_UNMOUNT;
			return *this;
		}
		if (copyOfStr == "ta_consume")
		{
			_Value = TA_CONSUME;
			return *this;
		}
