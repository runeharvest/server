...
//---------------------------------------------------
template <class C>
void loadSheetSet(const char *fileType, const char *sheetFile, C &sheetMap)
{
...
template <class C>
void loadSheetSet2(const char *fileType, const char *sheetFile, C &sheetMap)
{
	// clear out the previous sheet set	(just in case this is a re-read)
	sheetMap.clear();
...
//---------------------------------------------------
template <class T>
void loadSheetSet(const vector<string> &fileTypes, const char *sheetFile, T &sheetMap)
{
	// clear out the previous sheet set	(just in case this is a re-read)
	sheetMap.clear();
...
// ***************************************************************************
template <class T>
void reloadSheetSet(const vector<string> &fileTypes, T &sheetMap, const string &wildcardFilter)
{
	// clear out the previous sheet set	(just in case this is a re-read)
	sheetMap.clear();
...
// variant with smart pointers, maintain with function above
template <class T>
void reloadSheetSet2(const vector<string> &fileTypes, T &sheetMap, const string &wildcardFilter)
{
	// clear out the previous sheet set	(just in case this is a re-read)
	sheetMap.clear();
...
template <class T>
void reloadSheetSet(const string &fileType, T &sheetMap, const string &wildcardFilter)
{
	vector<string> fileTypes;
...
// variant with smart pointers, maintain with function above
template <class T>
void reloadSheetSet2(const string &fileType, T &sheetMap, const string &wildcardFilter)
{
	vector<string> fileTypes;
	fileTypes.push_back(fileType);
...
// ***************************************************************************
template <class T>
void reloadExistingSheets(T &src, T &dst)
{
...
// variant with smart pointers, maintain with function above
template <class T>
void reloadExistingSheets2(T &src, T &dst)
{
	typename T::const_iterator itSrc;
	for (itSrc = src.begin(); itSrc != src.end(); ++itSrc)
	{
...
// ***************************************************************************
template <class T>
void reloadCommonSheets(T &dst, const char *type, const string &wildcardFilter)
{
...
// variant with smart pointers, maintain with function above
template <class T>
void reloadCommonSheets2(T &dst, const char *type, const string &wildcardFilter)
{
	// Load sheets in a temp container
	T tmpContainer;
