	...
	*/
	...
	public:
		...
		inline CEntityIteratorTemplate(CEntityMatrix *matrix,
		    ...
		    sint32 centerX,
		    sint32 centerY)
		    : _CellIt(matrix, pattern, centerX, centerY)
		    , _CenterPosX(double(centerX) / 1000.0)
		    , _CenterPosY(double(centerY) / 1000.0)
		{
	...
	public:
		...
		inline CEntityIteratorDisc(CEntityMatrix *matrix, CEntityMatrixPatternSymetrical *pattern,
		    ...
		    sint32 posY,
		    double radiusSquare)
		    : CEntityIteratorTemplate<CEntityMatrixPatternSymetrical, CCellIterator<CEntityMatrixPatternSymetrical>>(matrix,
		          pattern,
		          posX,
		          posY)
	...
	public:
		...
		inline CEntityIteratorCone(CEntityMatrix *matrix,
		    ...
		    : CEntityIteratorTemplate<CEntityMatrixPatternRect, CCellIterator<CEntityMatrixPatternRect>>(matrix,
		          pattern,
		          center.X,
		          center.Y)
		    , _Cone(cone)
	...
	public:
		...
		inline CEntityIteratorChainBorder(CEntityMatrix *matrix,
		    ...
		    const TDataSetRow &actor,
		    const CEntityBase *mainTarget)
		    : CEntityIteratorTemplate<CEntityMatrixPatternBorder, CCellIteratorBorder<CEntityMatrixPatternBorder>>(matrix,
		          pattern,
		          posX,
		          posY)
		    , _RadiusSquare(radiusSquare)
