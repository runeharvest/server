...
{
public:
	enum TShopTypeSelected
	{
		StaticShopSelected = 0,
		DynamicShopSelected,
		AllShopSelected,
		InvalidShopSelected
	};
	...
	{
		return (category == _HairMale || category == _HairColorMale || category == _TatooMale || category == _HairFemale || category == _HairColorFemale || category == _TatooFemale);
	}
