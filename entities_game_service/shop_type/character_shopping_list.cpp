...
bool CCharacterShoppingList::passThruFilter(TItemTradePtr itemTrade, bool dynnamicShop)
{
	...
	if (form != 0)
	{
		...
		if (form->Family != ITEMFAMILY::PET_ANIMAL_TICKET && form->Family != ITEMFAMILY::HARVEST_TOOL && form->Family != ITEMFAMILY::FOOD && form->Family != ITEMFAMILY::HARVEST_TOOL && form->Family != ITEMFAMILY::CRAFTING_TOOL && form->Family != ITEMFAMILY::COSMETIC && form->Family != ITEMFAMILY::TELEPORT && form->Family != ITEMFAMILY::SERVICE && form->Family != ITEMFAMILY::GENERIC_ITEM && form->Family != ITEMFAMILY::CONSUMABLE)
		{
