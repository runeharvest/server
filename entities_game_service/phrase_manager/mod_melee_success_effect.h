...
#ifndef RY_MOD_MELEE_SUCCESS_EFFECT_H
#define RY_MOD_MELEE_SUCCESS_EFFECT_H
...
/**
 * Effect class affecting melee success chance
 * \author Stephane Coutelas
 * \author Nevrax France
 * \date 2006
 */
class CModMeleeSuccessEffect : public CSTimedEffect
{
public:
	NLMISC_DECLARE_CLASS(CModMeleeSuccessEffect)

	DECLARE_PERSISTENCE_METHODS

	/// default ctor
	CModMeleeSuccessEffect()
	    : CSTimedEffect()
	{
	}

	///\ctor
	CModMeleeSuccessEffect(const TDataSetRow &creatorRowId, uint32 endDate, EFFECT_FAMILIES::TEffectFamily effectFamily, float modifier1, float modifier2)
...
#endif // RY_MOD_MELEE_SUCCESS_EFFECT_H

/* End of mod_melee_success_effect.h */
