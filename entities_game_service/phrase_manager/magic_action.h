...
#define END_MAGIC_ACTION_FACTORY(_class_)                                                                                                                                      \
	...
	{                                                                                                                                                                          \
		...
		if (!inst->build(actorRowId, bricks, brickIndex, buildParams, phrase))                                                                                                 \
		{                                                                                                                                                                      \
			delete inst;                                                                                                                                                       \
			return NULL;                                                                                                                                                       \
		}                                                                                                                                                                      \
 ...
 */
template <class T>
class CMagicAiActionTFactory : public IMagicAiActionFactory
{
public:
 ...
 */
template <class T>
class CMagicAiSpecializedActionTFactory : public IMagicAiActionFactory
{
public:
