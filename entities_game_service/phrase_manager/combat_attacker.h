...
public:
	...
	/// copy constructor
	inline CCombatWeapon(const CCombatWeapon &weapon)
	{
		init();
		(*this) = weapon;
	}
...
public:
	...
	CCombatAttacker(const TDataSetRow &rowId)
	    : _RowId(rowId)
	{
	}
...
{
public:
	CCombatAttackerPlayer(const TDataSetRow &rowId)
...
public:
	...
	inline explicit CCombatAttackerAI(const TDataSetRow &rowId)
	    : CCombatAttacker(rowId)
	{
		initFromRowId(rowId);
	}
