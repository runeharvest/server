...
inline CByteCode::CByteCode(std::string const &sourceName)
    : _sourceName(sourceName)
{
}

inline CLibrary &CLibrary::getInstance()
{
	if (_instance == NULL)
...
inline void CLibrary::destroyInstance()
{
	if (_instance != NULL)
	{
		delete _instance;
...
inline CScriptStack::CStackEntry::CStackEntry()
    : _type(ENone)
{
}
...
inline void CScriptStack::CStackEntry::clean()
{
	if (_type == EString)
		delete &getString();
}

inline CScriptStack::CStackEntry &CScriptStack::CStackEntry::operator=(float const &f)
{
	clean();
	_vali = *((int *)&f);
	_type = EFloat;
...
inline CScriptStack::CStackEntry &CScriptStack::CStackEntry::operator=(int const &i)
{
	clean();
	_vali = i;
	_type = EOther;
...
inline CScriptStack::CStackEntry &CScriptStack::CStackEntry::operator=(std::string const &str)
{
	clean();
...
inline CScriptStack::CStackEntry &CScriptStack::CStackEntry::operator=(IScriptContext *sc)
{
	clean();
	_valp = *((uintptr_t *)&sc);
	_type = EContext;
...
inline bool CScriptStack::CStackEntry::operator==(CStackEntry const &other) const
{
...
inline CScriptStack::CStackEntry::operator float &()
{
	return getFloat();
}
inline CScriptStack::CStackEntry::operator int &()
{
	return getInt();
}
inline CScriptStack::CStackEntry::operator std::string &()
{
	return getString();
}
inline CScriptStack::CStackEntry::operator IScriptContext *()
{
	return getIScriptContext();
}

inline CScriptStack::TStackTypes CScriptStack::CStackEntry::type() const
{
	return _type;
}

inline std::string &CScriptStack::CStackEntry::getString()
{
	nlassert(_type == EString);
	return *(*((std::string **)&_valp));
}
inline std::string const &CScriptStack::CStackEntry::getString() const
{
	nlassert(_type == EString);
	return *(*((std::string **)&_valp));
}
inline IScriptContext *CScriptStack::CStackEntry::getIScriptContext()
{
	nlassert(_type == EContext);
	return *((IScriptContext **)&_valp);
}
inline int &CScriptStack::CStackEntry::getInt()
{
	nlassert(_type == EOther);
	return _vali;
}
inline int const &CScriptStack::CStackEntry::getInt() const
{
	nlassert(_type == EOther);
	return _vali;
}
inline float &CScriptStack::CStackEntry::getFloat()
{
	nlassert(_type == EFloat);
	return *((float *)&_vali);
}
inline float const &CScriptStack::CStackEntry::getFloat() const
{
	nlassert(_type == EFloat);
	return *((float const *)&_vali);
}

inline void CScriptStack::push(float const &val)
{
	_Stack.push_back(CStackEntry());
	_Stack.back() = val;
}
inline void CScriptStack::push(std::string const &val)
{
	_Stack.push_back(CStackEntry());
	_Stack.back() = val;
}
inline void CScriptStack::push(IScriptContext *val)
{
	_Stack.push_back(CStackEntry());
	_Stack.back() = val;
}
inline void CScriptStack::push(int val)
{
	_Stack.push_back(CStackEntry());
	_Stack.back() = val;
}

inline CScriptStack::CStackEntry &CScriptStack::top() //	is this an optimisation of the method below ?
{
	return _Stack.back();
}
inline CScriptStack::CStackEntry &CScriptStack::top(int index)
{
	return *(_Stack.rbegin() + index);
}

inline void CScriptStack::pop()
{
	_Stack.pop_back();
}

inline CStringSeparator::CStringSeparator(const std::string &str, const std::string &motif)
    : _Index(0)
    , _NewIndex(0)
    , _Delta(0)
    , _StartIndex(0)
...
inline CStringSeparator::~CStringSeparator()
{
}
inline void CStringSeparator::reset() const
{
	_Index = 0;
	_NewIndex = 0;
	_Delta = 0;
...
inline std::string CStringSeparator::get() const
{
#if !FINAL_VERSION
	nlassert(_Delta > 0);
#endif
...
inline bool CStringSeparator::hasNext() const
{
	calcNext();
	return _Delta > 0;
}
inline void CStringSeparator::calcNext() const
{
	_Delta = 0;
