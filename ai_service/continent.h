...
public:
	...
	void addSubstitutionGroupFamilyId(size_t id)
	{
		nlassert(id != 0);
		_SubstitutionGroupFamilyIds.insert(id);
	}
	void removeSubstitutionGroupFamilyId(size_t id)
	{
		nlassert(id != 0);
		_SubstitutionGroupFamilyIds.erase(id);
	}
