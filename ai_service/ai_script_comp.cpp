...
{
public:
	CFightAggroBlock(const uint32 time)
	    : _Time(time)
	{
	}
...
{
public:
	CFightDamageCoef(const float coef)
	    : _Coef(coef)
	{
	}
...
{
public:
	CFightGroupDamageCoef(const float coef)
	    : _Coef(coef)
	{
	}
...
{
public:
	CFightDamageSpeedCoef(const float coef)
	    : _Coef(coef)
	{
	}
...
{
public:
	CFightSetRandomTarget(const float coef)
	    : _Coef(coef)
	{
	}
