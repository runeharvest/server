...
inline CAIEntityPhysical::CAIEntityPhysical(CPersistentOfPhysical &owner, TDataSetRow const &entityIndex, NLMISC::CEntityId const &id, float radius, uint32 level, RYAI_MAP_CRUNCH::TAStarFlag const &AStarFlags)
    : CAIEntity()
...
inline CAIEntityPhysical::~CAIEntityPhysical()
{
...
inline void CAIEntityPhysical::setActionFlags(RYZOMACTIONFLAGS::TActionFlag const &flag)
{
	_ActionFlags = (_ActionFlags.getValue() | flag);
}

inline void CAIEntityPhysical::removeActionFlags(RYZOMACTIONFLAGS::TActionFlag const &flag)
{
	_ActionFlags = (_ActionFlags.getValue() & ~flag);
}

inline float CAIEntityPhysical::getCollisionDist(float angTo) const
{
	return 0.5;
}

inline bool CAIEntityPhysical::canMove() const
{
	return !isRooted() && (walkSpeed() != 0);
}

inline float CAIEntityPhysical::walkSpeed() const
{
	return _WalkSpeed() * 0.1f * SpeedFactor * getSpeedFactor();
}

inline float CAIEntityPhysical::runSpeed() const
{
	return _RunSpeed() * 0.1f * SpeedFactor * getSpeedFactor();
}

inline void CAIEntityPhysical::setWPos(RYAI_MAP_CRUNCH::CWorldPosition const &pos)
{
...
inline bool CPersistentOfPhysical::isAt16MetersPos(uint16 x, uint16 y) const
{
...
inline CAIEntityPhysical *CPersistentOfPhysical::getSpawnObj() const
{
...
inline void CModEntityPhysical::setMode(MBEHAV::EMode m)
{
...
inline void CModEntityPhysical::setTarget(CAIEntityPhysical *target)
{
...
inline void CModEntityPhysical::setVisualTarget(CAIEntityPhysical *target)
{
...
inline void CModEntityPhysical::setUnreachableTarget(CAIEntityPhysical *target)
{
...
inline bool CModEntityPhysical::setPos(CAIPos const &pos)
{
...
inline bool CModEntityPhysical::moveTo(CAIPos const &newPos, RYAI_MAP_CRUNCH::TAStarFlag const &denyFlags)
{
	if (!wpos().isValid())
		return false;
...
inline void CModEntityPhysical::resetDecalage()
{
	_Decalage.setXY(0, 0);
}
