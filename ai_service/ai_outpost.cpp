...
void COutpost::update()
{
	...
	FOREACH(it, CAliasCont<COutpostManager>, _Managers)
	it->update();
}
...
template <>
size_t const CGroupDesc<COutpostSquadFamily>::_MultiLevelSheetCount = 20;
...
template <>
size_t const CBotDesc<COutpostSquadFamily>::_MultiLevelSheetCount = 20;
