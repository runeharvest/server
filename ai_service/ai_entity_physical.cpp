...
template <>
CKnapsackSolver::Algorithm CTargetable<CAIEntityPhysical>::_TargeterChoiceAlgorithm = CKnapsackSolver::FastSingleReplace;
template <>
float const CTargetable<CAIEntityPhysical>::_DefaultFightTargetersWeightMax = 6.f;
template <>
float const CTargetable<CAIEntityPhysical>::_DefaultFightWeight = .98f;
template <>
float const CTargetable<CAIEntityPhysical>::_DefaultFightValue = 1.f;
...
inline CAIVector CModEntityPhysical::calcRepulsionFrom(const CAIVector &pos, const std::vector<const CAIEntityPhysical *> &entities) const
{
...
inline bool CModEntityPhysical::calcStraightRepulsionFrom(const CAIVector &pos, const std::vector<const CAIEntityPhysical *> &entities, CAIVector &repulsion) const
{
