...
bool CKnownUser::update(MSW::CConnection &connection)
{
	...
	qs += ", ";
	qs += "relation_type = " + (_Relation.isValid() ? "'" + _Relation.toString() + "'" : "DEFAULT(relation_type)");
	qs += ", ";
...
bool CSessionParticipant::update(MSW::CConnection &connection)
{
	...
	qs += ", ";
	qs += "status = " + (_Status.isValid() ? "'" + _Status.toString() + "'" : "DEFAULT(status)");
	qs += ", ";
...
bool CCharacter::update(MSW::CConnection &connection)
{
	...
	qs += ", ";
	qs += "race = " + (_Race.isValid() ? "'" + _Race.toString() + "'" : "DEFAULT(race)");
	qs += ", ";
	qs += "civilisation = " + (_Civilisation.isValid() ? "'" + _Civilisation.toString() + "'" : "DEFAULT(civilisation)");
	qs += ", ";
	qs += "cult = " + (_Cult.isValid() ? "'" + _Cult.toString() + "'" : "DEFAULT(cult)");
	qs += ", ";
...
bool CRingUser::update(MSW::CConnection &connection)
{
	...
	qs += "current_session = '" + MSW::escapeString(NLMISC::toString(_CurrentSession), connection) + "'";
	qs += ", ";
	qs += "current_activity = " + (_CurrentActivity.isValid() ? "'" + _CurrentActivity.toString() + "'" : "DEFAULT(current_activity)");
	qs += ", ";
	qs += "current_status = " + (_CurrentStatus.isValid() ? "'" + _CurrentStatus.toString() + "'" : "DEFAULT(current_status)");
	qs += ", ";
	qs += "public_level = " + (_PublicLevel.isValid() ? "'" + _PublicLevel.toString() + "'" : "DEFAULT(public_level)");
	qs += ", ";
	qs += "account_type = " + (_AccountType.isValid() ? "'" + _AccountType.toString() + "'" : "DEFAULT(account_type)");
	qs += ", ";
	...
	qs += ", ";
	qs += "lang = " + (_Lang.isValid() ? "'" + _Lang.toString() + "'" : "DEFAULT(lang)");
	qs += ", ";
...
bool CSession::update(MSW::CConnection &connection)
{
	...
	qs += "session_type = " + (_SessionType.isValid() ? "'" + _SessionType.toString() + "'" : "DEFAULT(session_type)");
	qs += ", ";
	...
	qs += "description = '" + MSW::escapeString(NLMISC::toString(_Description), connection) + "'";
	qs += ", ";
	qs += "orientation = " + (_Orientation.isValid() ? "'" + _Orientation.toString() + "'" : "DEFAULT(orientation)");
	qs += ", ";
	qs += "level = " + (_Level.isValid() ? "'" + _Level.toString() + "'" : "DEFAULT(level)");
	qs += ", ";
	qs += "rule_type = " + (_RuleType.isValid() ? "'" + _RuleType.toString() + "'" : "DEFAULT(rule_type)");
	qs += ", ";
	qs += "access_type = " + (_AccessType.isValid() ? "'" + _AccessType.toString() + "'" : "DEFAULT(access_type)");
	qs += ", ";
	qs += "state = " + (_State.isValid() ? "'" + _State.toString() + "'" : "DEFAULT(state)");
	qs += ", ";
	...
	qs += ", ";
	qs += "estimated_duration = " + (_EstimatedDuration.isValid() ? "'" + _EstimatedDuration.toString() + "'" : "DEFAULT(estimated_duration)");
	qs += ", ";
	...
	qs += ", ";
	qs += "anim_mode = " + (_AnimMode.isValid() ? "'" + _AnimMode.toString() + "'" : "DEFAULT(anim_mode)");
	qs += ", ";
	qs += "race_filter = '" + _RaceFilter.toString() + "'";
	qs += ", ";
	qs += "religion_filter = '" + _ReligionFilter.toString() + "'";
	qs += ", ";
	qs += "guild_filter = " + (_GuildFilter.isValid() ? "'" + _GuildFilter.toString() + "'" : "DEFAULT(guild_filter)");
	qs += ", ";
...
bool CShard::update(MSW::CConnection &connection)
{
	...
	qs += ", ";
	qs += "RequiredState = " + (_RequiredState.isValid() ? "'" + _RequiredState.toString() + "'" : "DEFAULT(RequiredState)");
	qs += ", ";
...
bool CJournalEntry::update(MSW::CConnection &connection)
{
	...
	qs += "author = '" + MSW::escapeString(NLMISC::toString(_Author), connection) + "'";
	qs += ", ";
	qs += "type = " + (_Type.isValid() ? "'" + _Type.toString() + "'" : "DEFAULT(type)");
	qs += ", ";
